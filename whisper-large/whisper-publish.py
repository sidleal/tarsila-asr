...
#fine_tuned_model_name = "whisper-tarsila-asr-medium-v1-350k"
fine_tuned_model_name = "whisper-tarsila-asr-large3-v1-450k"

hf_token = "xxxx"
dataset_link = "sidleal/TARSILA-ASR-V1"

os.environ["WANDB_API_KEY"] = "f7421cf9b7e382afe518530290443943f1a2543a" 
os.environ["WANDB_PROJECT"] = "tarsila-asr-whisper-medium"
os.environ["WANDB_RUN_NAME"] = f"tarsila-asr-whisper-run-1ab"
wandb.init(project="tarsila-asr-whisper-medium", name=f"tarsila-asr-whisper-run-1ab")
...
model = WhisperForConditionalGeneration.from_pretrained(f"{base_output_dir}/whisper-large-v3-pt-tst/checkpoint-450000")
#model = WhisperForConditionalGeneration.from_pretrained(f"{base_output_dir}/whisper-medium-pt-tst/checkpoint-350000")
...
#    "language": "pt",
#    "model_name": "whisper-tarsila-asr-medium-v1-350k",  # a 'pretty' name for your model
...
kwargs = {
    ...
    "dataset": "TARSILA-ASR-V1",  # a 'pretty' name for the training dataset
    "language": "pt",
    "model_name": "whisper-tarsila-asr-large3-v1-450k",  # a 'pretty' name for your model
